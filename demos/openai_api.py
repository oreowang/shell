...
# coding=utf-8
# Implements API for Shell in OpenAI's format. (https://platform.openai.com/docs/api-reference/chat)
...
async def list_models():
    global model_args
    model_card = ModelCard(id="Shell-7B-Chat")
...
def _get_args():
    ...
    parser.add_argument(
        ...
        "--checkpoint-path",
        type=str,
        default="WisdomShell/Shell-7B-Chat",
